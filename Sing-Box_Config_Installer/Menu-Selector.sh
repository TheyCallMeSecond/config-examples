...
processes=("SH:Hysteria2:/etc/hysteria2/server.json" "TS:TUIC:/etc/tuic/server.json" "RS:Reality:/etc/reality/config.json" "ST:ShadowTLS:/etc/shadowtls/config.json" "WS:WebSocket:/etc/ws/config.json")
