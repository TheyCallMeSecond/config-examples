...
سرور اوبونتو
 ...
 اختیاری : کلید وارپ پلاس (دریافت از طریق همین اسکریپت)
 
 (همچنین میتونید از [این بات تلگرام](https://t.me/generatewarpplusbot " این بات تلگرام") برای گرفتنش استفاده کنید)
...
حتما قبل از نصب پروتکل ها سرورتون رو اپتیمایز کنید (کارایی که انجام میشه : آپدیت و آپگرید سرور...نصب آخرین ورژن کرنل زن-مود...نصب پکیج های مورد نیاز...فعال کردن آیپی ورژن 6...فعال کردن بی بی آر...اپتیمایز کردن کانکشن اس اس اچ...اپتیمایز کردن لیمیت ها...فعال کردن فایروال)
 ...
 برای فعال کردن وارپ : ابتدا کد وارپ پلاس رو از طریق اسکریپت دریافت کنید. وارپ رو نصب کنید بعد روی هر پروتکلی که خواستید فعالش کنید
